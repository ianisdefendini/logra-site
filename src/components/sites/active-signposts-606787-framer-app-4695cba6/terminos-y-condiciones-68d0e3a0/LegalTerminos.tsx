 ...
 * Long-form text document on #FFFFFF: centered ~700px column, pill badge +
...
export function LegalTerminos() {
  return (
    <section className="logra-legal">
      ...
      <p>Estos Términos y Condiciones constituyen un contrato válido entre los Usuarios como clientes actuales o futuros Digitizeme Inc. (“Alkyo”, “nosotros”, o “nuestro”), sus afiliadas y vinculadas y rigen el uso de los contenidos y Servicios ofrecidos a través de la Plataforma.</p>
      ...
      <Sec n={1} title="Servicios de Alkyo" />
      <p>Alkyo proporciona software y servicios que recomiendan a las pequeñas y medianas (Pymes) empresas, estrategias y herramientas a implementar paso a paso, para ayudarles a crecer o innovar en su día a día y a diagnosticar e identificar los retos de negocio o desafíos que enfrentan las Pymes, así como, guías en cómo implementar las acciones, herramientas, soluciones y mejoras prácticas para el crecimiento de las empresas. Adicionalmente, Alkyo conecta a las Pymes con expertos, consultores y proveedores de servicios dentro de la plataforma (los “Servicios”). Los Servicios también se refieren a los productos, aplicaciones y servicios de Alkyo, en cada caso en cualquier formato en que puedan ofrecerse ahora o en el futuro.</p>
      <p>Entre los Servicios, Alkyo ofrece una amplia gama de funcionalidades que están igualmente sujetas a estos Términos y Condiciones, entre los que se incluyen:</p>
      <Bt>Sitios web;</Bt>
      ...
      <p>Todo el contenido, herramientas y funcionalidades de la Plataforma son de titularidad de Alkyo o esta última tiene autorización para publicarla en la Plataforma. Por lo anterior, toda información contenida en esta Plataforma tales como, imágenes, texto, creaciones, mensajes, ilustraciones, gráficos, logos, diseños, fotografías, iconos, programa, datos, música, sonidos, videos, bases de datos o cualquier otro material son propiedad de Alkyo o de terceros que han autorizado a Alkyo su uso y explotación. Por lo tanto, no se permitirá de ninguna manera al Usuario copiar, reproducir, distribuir, transmitir, publicar total o parcialmente o utilizar por cualquier otro medio, el material de este sitio sin previa autorización de Alkyo. De igual manera, no se autoriza el redireccionamiento a este sitio o copia en espejo sin previa autorización. Alkyo respeta los derechos de autor de otros sitios y por lo tanto solicita a la comunidad navegante de Internet que aplique la misma teoría. Frente a los redireccionamientos que puedan generarse desde la Plataforma, Alkyo no se responsabilizará por ningún contenido, inconveniente, error o cualquier particularidad que pueda ocurrir en dicha URL.Logra puede cancelar las cuentas de los Usuarios unilateralmente y sin previo aviso, siempre que considere que ha existido violación de sus derechos de propiedad intelectual y/o de terceros y podrá iniciar acciones legales contra los violadores de estos derechos.</p>
      <p>El material de la Plataforma es suministrado sobre la base de &quot;tal como es&quot;, por lo tanto, Alkyo no otorga ningún tipo de garantía, expresa o implícita, sobre dicho material. Alkyo advierte a los Usuarios que la información de la Plataforma puede contener errores o inexactitudes, no estar completa o actualizada. Por ello, Alkyo se reserva el derecho de corregir cualquier error, omisión o inexactitud, cambiar o actualizar la misma en cualquier momento y sin previo aviso.</p>
      <p>La Plataforma, puede contener enlaces a otros sitios para propósitos de referencia y apoyo. De igual manera, si el usuario tuviere sistemas contables o ERP’s, de uso simultaneo con la Plataforma, el Usuario reconoce que Alkyo no tiene ningún control o administración sobre estos sitios, por ende, no se responsabiliza de daños o perjuicios que causen estos sitios, el Usuario acepta que Alkyo no es responsable en caso de daños causados directa o indirectamente a su equipo al entrar a estos sitios.</p>
      ...
      <p>Algunos de los Servicios se han diseñado para que el Usuario registrado pueda cargar, subir, transferir, almacenar, enviar, recibir o compartir su contenido. El Usuario registrado no tiene ninguna obligación de proporcionar ningún contenido a la Plataforma. El Usuario puede elegir libremente el contenido que quiere facilitarnos. Si el Usuario decide cargar, subir o compartir contenido, deberá asegurarse de que tiene los derechos y autoridad necesarios para ello y de que dicho contenido no viola la ley aplicable. Alkyo no se hará responsable en ningún caso por dicho contenido</p>

      <Sec n={2} title="Licencia de Uso" />
      <p>El contenido de los Usuarios es y será de su propiedad, lo que significa que seguirá siendo titular de los derechos de propiedad intelectual que tengas sobre dicho contenido. El Usuario conservará los derechos de propiedad intelectual sobre el contenido que cree. A través de estos Términos y Condiciones, el Usuario registrado concede una licencia a Alkyo y la Plataforma sobre su contenido en caso que resulte necesario para la adecuada prestación de los Servicios.</p>
      <p>Esta licencia permite a Alkyo, con respecto al contenido que carga el Usuario registrado, titular de una cuenta, en la Plataforma:</p>
      ...
      <Sec n={3} title="Uso de los Servicios; cuenta de Alkyo" />
      ...
      <p>Si un Usuario no tiene la edad mínima para poder gestionar su propia cuenta de Alkyo debe contar con el permiso de su padre, madre, representante o tutor legal para utilizar una cuenta de Alkyo. Si un padre, madre, representante o tutor legal permite a su hijo/a que utilice los Servicios, se aplican estos Términos y Condiciones y es responsable de la actividad que realice en la Plataforma.</p>
      <p>Si el Usuario registrado cumple con los requisitos de edad mínima, puede crear una cuenta de Alkyo. Para el correcto funcionamiento de los Servicios, es obligatorio tener una cuenta de Alkyo, proporcionando su nombre legal completo, una dirección de correo electrónico válida y cualquier otra información necesaria para completar el proceso de registro. Como regla general, sus datos de acceso pueden ser utilizados hasta un máximo de cinco sesiones simultáneas; siempre, sin embargo, que Alkyo pueda reducir este límite a su discreción para hacer frente a problemas conocidos o sospechados de uso compartido inapropiado de licencias.</p>
      <p>El Usuario registrado es responsable del uso de la cuenta de Alkyo, y esto incluye tomar las medidas necesarias para mantener la cuenta protegida. Recomendamos que el Usuario registrado use periódicamente la revisión de seguridad.</p>
      ...
      <It m="(b)">El administrador de la organización puede asignarle al Usuario una cuenta de Alkyo. Dicho administrador puede exigirle al Usuario el cumplimiento de otras normas, y puede tener la capacidad de acceder a la cuenta de Alkyo del Usuario o de inhabilitarlo.</It>
      <p>En los casos en los que el Usuario corresponda a una persona jurídica, deberá estar debidamente constituida y la persona natural encargada de la cuenta Alkyo deberá tener las facultades para administrar la cuenta. Así mismo, el Usuario cuenta con las autorizaciones requeridas para obligarse conforme a estos Términos y Condiciones.</p>
      <p>En todo caso, será responsabilidad de la empresa el manejo que la persona asignada le dé a la cuenta de Alkyo y Alkyo tendrá la facultad de deshabilitarlo si encuentra un manejo inadecuado de la misma.</p>
      ...
      <It m="(d)">Utilizará los Servicios para beneficio de la empresa que representa y seguirá todas las instrucciones de uso que se presenten a medida que vaya utilizando cada una de las herramientas provistas por Alkyo.</It>
      <Gap />
      ...
      <Gap />
      <It m="5.6.">Alkyo se reserva el derecho a terminar inmediatamente el servicio y el uso de la Plataforma en caso de que incumpla alguna de las reglas y obligaciones anteriores.</It>
      ...
      <It m="(a)">Acceder o supervisar cualquier material o información en algún sistema de Alkyo usando cualquier proceso manual o medios como robot, spider, scraper, integraciones, APIs disponibles o cualquier otro medio automatizado;</It>
      ...
      <It m="(d)">Obtener o intentar obtener acceso a cualquier información confidencial de Alkyo o de otros Usuarios a través de cualquier medio. El uso de bots, códigos de automatización malware y/o similares que tenga como fin el acceso a o robo de información confidencial;</It>
      <It m="(e)">Utilizar la Plataforma para ejercer acciones de competencia desleal;</It>
      <It m="(f)">Copiar, reproducir, alterar, modificar, crear trabajos derivados, exhibir públicamente, reeditar, cargar, publicar, transmitir, revender o distribuir de alguna manera material, información o Servicios de Alkyo;</It>
      <It m="(g)">Transferir los derechos que a Usted se le otorguen en virtud de estos Términos y Condiciones;</It>
      <It m="(h)">Utilizar los Servicios para cualquier actividad o productos ilegales tanto nacionales como internacionales de cualquier manera que le exponga a algún perjuicio a Usted, a otros Usuarios de Alkyo a nuestros socios o a Alkyo; o</It>
      ...
      <Gap />
      <It m="7.4.">Impuestos. Todas las tarifas excluyen todos los impuestos, gravámenes, derechos o tasas similares de cualquier naturaleza, incluidos, por ejemplo, los impuestos sobre el valor añadido, las ventas, el uso o las retenciones, gravables por cualquier jurisdicción (colectivamente “Impuestos”). El Usuario será responsable del pago de todos los Impuestos asociados con su compra de acceso al Servicio, excluyendo sólo aquellos impuestos que se basan en los ingresos netos de Alkyo. En caso de que el Usuario deba retener algún Impuesto en el momento del pago a Alkyo, el Usuario reembolsará a Alkyo dicha retención.</It>
      <Gap />
      <It m="7.5.">Suscripciones de prueba. Alkyo puede, a su elección, ofrecer a nuevos clientes una prueba gratuita limitada del Servicio, sujeta a estos Términos. Sin perjuicio de cualquier disposición en contrario en este documento, Alkyo tendrá derecho a rescindir la prueba gratuita de un Usurario en cualquier momento y por cualquier motivo. Ninguna organización o individuo tiene derecho a recibir más de una (1) prueba gratuita del Servicio.</It>
      <Gap />
      <It m="7.6.">Los montos por los servicios de Alkyo podrán ser pagados entre cualquiera de los siguientes métodos de pago, según Alkyo otorgue disponibilidad de los mismos: Tarjeta de Crédito, Tarjeta Débito o PSE.</It>
      <Gap />
      <It m="7.7.">Mora. Si no efectúa los pagos (no impugnados de buena fe) a su vencimiento conforme a estas Condiciones, y tras un impago continuado durante un periodo de quince (15) días calendario después de que le hayamos notificado por escrito y le hayamos dado la oportunidad de subsanarlo, podremos suspender la prestación del Servicio hasta que se reciba el pago y podremos cobrarle una comisión por demora sobre el importe vencido a partir de la fecha de vencimiento de dicho importe al tipo menor entre el 1,5% mensual o el tipo máximo permitido por la legislación aplicable, junto con nuestros costes incurridos en el cobro de dicho pago. Tenemos derecho a retener la ejecución y suspender la prestación del Servicio hasta que se abonen íntegramente todas las cantidades adeudadas que no hayan sido impugnadas. Alkyo se reserva el derecho de emprender acciones judiciales y extrajudiciales que estime pertinentes para obtener el pago del monto debido.</It>

      <Sec n={8} title="Política de Cancelación" />
      <p>El Usuario podrá́ terminar unilateralmente su cuenta Alkyo en la plataforma en cualquier momento que así lo desee, la cual se entenderá cancelada a las 4 semanas contadas desde la solicitud . Durante el periodo comprendido entre la fecha de solicitud de cancelación, el Cliente tendrá acceso a los Servicios y podrá hacer uso de los mismos. La cancelación de la cuenta de Alkyo implica la eliminación del contenido del Usuario. Alkyo no asumirá ninguna responsabilidad frente al Usuario por cualquier cancelación y/o suspensión de la cuenta de Alkyo o la eliminación del contenido del Usuario.</p>

      <Sec n={9} title="Acceso a la Plataforma" />
      <It m="9.1.">Alkyo no garantiza el acceso a la Plataforma, al contenido ni a los módulos, de tal forma no será responsable de que ésta se encuentre libre de errores, software malicioso, o que pueda causar algún daño a nivel de software o hardware en el equipo a través del cual el Usuario accede a la Plataforma. Alkyo tampoco se hace responsable de los daños que pudiesen ocasionarse por un uso inadecuado de la Plataforma y en ningún caso será responsable por las pérdidas, daños o perjuicios de cualquier tipo que surjan por el sólo acceso o utilización de la Plataforma.</It>
      <Gap />
      ...
      <It m="10.1.">Alkyo ha implementado medidas técnicas y organizativas que tienen como objetivo proteger su información contra destrucciones, pérdidas accidentales, alteraciones y contra el acceso, uso, modificación o divulgación no autorizados. Sin embargo, Alkyo no puede garantizar que terceros no autorizados no puedan sobrepasar esas medidas ni usar su información con fines indebidos. El Usuario reconoce que brinda su información bajo su propio riesgo y así mismo se compromete a adoptar las medidas necesarias que estén a su alcance para asegurar la privacidad de los datos personales recabados de forma que se garantice su seguridad, se evite su alteración, pérdida o tratamiento no autorizado.</It>
      <It m="10.2.">Los Usuarios deberán acogerse a la Política de Privacidad. Al utilizar cualquiera de nuestros Servicios, aceptan que nuestras prácticas de datos personales le apliquen de la manera en la que se establece en la Política de Privacidad. La Política de Privacidad explica cómo Alkyo maneja la información personal que los Usuarios nos proporciona cuando Alkyo hace uso de sus datos personales para proporcionarle los Servicios o para sus propios fines. Se le recomienda a los Usuarios que se familiaricen con la Política de Privacidad antes de usar la Plataforma y adquirir los Servicios.</It>
      <It m="10.3.">Alkyo se reserva el derecho a modificar su Política de Privacidad, de acuerdo con sus necesidades o de acuerdo con la legislación aplicable. El acceso o utilización de la Plataforma por parte del Usuario después de dichos cambios, implicará la aceptación de estos cambios.</It>

      <Sec n={11} title="Indemnidad" />
      <p>El Usuario, exonera de toda responsabilidad a Alkyo sus afiliadas y vinculadas y se obliga a mantener indemne a Alkyo y a nuestros respectivos empelados, directores, agentes, afiliados, vinculadas y representantes de cualquier reclamo, costo, pérdida, daño, juicio, evaluación de impuestos, multa, interés; perjuicio, daño, pasivo y/o contingencia (incluidos sin limitación honorarios razonables de abogados) que surjan de cualquier reclamo, acción, auditoría, investigación, indagación o en relación con los mismos, u otro procedimiento iniciado por cualquier persona o entidad que surja o se relacione con: (a) cualquier incumplimiento real o supuesto de sus declaraciones, garantías u obligaciones reconocidos en los presentes Términos y Condiciones; (b) el uso indebido o inapropiado de los Servicios; (c) la violación de cualquier derecho de terceros, inclusive cualquier derecho de privacidad, de publicidad o de propiedad intelectual; (d) la violación de cualquier ley, norma o reglamento en cualquier otro país; (e) el acceso y/o uso de los Servicios con su nombre único, contraseña u otro código de seguridad adecuado por otras partes;  (f) cualquier transacción, compra, producto o servicio con respecto al cual Alkyo le proporcione, o le haya proporcionado, servicios de procesamiento de pagos de conformidad con los Términos y Condiciones; (g) cualquier queja, reclamo, o perjuicio que llegaren a causar a sus clientes y/o terceros con la comercialización de sus productos y/o servicios ofertados; y, (h) el incumplimiento de cualquier disposición conforme a la protección del consumidor.</p>

      <Sec n={12} title="Limitación de responsabilidad de Alkyo" />
      <It m="12.1.">En ningún caso Alkyo sus afiliadas y vinculadas, ni su personal, ni cualquier parte involucrada en la producción de los Servicios será responsable por daños directos o indirectos, ni por las pérdidas intangibles que se originen por la violación de los presentes Términos y Condiciones.</It>
      <It m="12.2.">Alkyo responderá única y exclusivamente frente a terceros y frente al Usuario, en aquellos casos en que se demuestre culpa grave o dolo por parte de Alkyo en la causa que originó el daño o evento por el que se deba responder. De igual manera, Alkyo responderá única y exclusivamente hasta por el valor total de las facturas efectivamente pagadas por el Usuario durante el último año.</It>

      <Sec n={13} title="Ley aplicable y fuero" />
      <p>Estos Términos y Condiciones están regidos por la ley vigente en la República de Colombia. Cualquier controversia que se origine en contra de Alkyo con ocasión o como consecuencia de estos Términos, se resolverá ante los jueces y tribunales de la justicia ordinaria.</p>
