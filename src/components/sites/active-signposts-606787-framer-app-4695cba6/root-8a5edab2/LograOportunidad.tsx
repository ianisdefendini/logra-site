...
export default function LograOportunidad() {
  return (
    <section style={{ background: "#faf9f7", padding: "100px 20px 120px" }}>
      <style>{`
        .logra-oportunidad-grid {
          display: grid;
        ...
        .logra-oportunidad-collage { height: 400px; }
        @media (max-width: 809px) {
          .logra-oportunidad-grid { grid-template-columns: 1fr; }
          .logra-oportunidad-collage { height: 280px; }
        }
      `}</style>
      <div className="logra-oportunidad-grid">
        <div>
          <div
            style={{
              display: "inline-flex",
          ...
          >
            4000+ empresarios ya usan Logra para mejorar cada día
          </h2>
          ...
          >
            Pruébalo sin costo hoy y obtén resultados de inmediato.
          </p>
        ...
        <div
          className="logra-oportunidad-collage"
          style={{
            background: "#dbe4eb",
            borderRadius: 16,
            position: "relative",
