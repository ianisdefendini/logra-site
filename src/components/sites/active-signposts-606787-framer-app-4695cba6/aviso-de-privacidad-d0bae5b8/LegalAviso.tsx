...
export function LegalAviso() {
  return (
    <section className="logra-legal">
      ...
      <p><em>Cuenta Alkyo</em>. Cuenta de Usuarios registrados de Alkyo para el uso de la Plataforma.</p>
      ...
      <p><em>Plataforma</em>. significan Sitios Web de Alkyo (incluyendo sin limitación www.alkyo.ai, app.alkyo.ai,  red.alkyo.ai, pro.alkyo.ai y cualquier URL sucesora, versiones móviles o localizadas y dominios y subdominios relacionados) y el conjunto de sistemas administrados por Alkyo.</p>
      ...
      <p><em>Titular</em>. Persona natural o jurídica cuyos Datos Personales sean objeto de Tratamiento, quien podrá ser o no Usuario de Alkyo.</p>
      <p><em>Usuario</em>. Significa (a) cualquier persona que acceda a la Plataforma o (b) cualquier persona que luego de haber accedido a la Plataforma, se haya registrado o se convierta en cliente de Alkyo; en cada caso, conforme a lo establecido en los Términos y Condiciones.</p>
      ...
      <It m="(g)">Incluir en sus Bases de Datos y darle Tratamiento a la información adquirida en virtud de la relación existente entre los Titulares y Alkyo;</It>
      <It m="(h)">Mejorar los servicios de Alkyo a través del desarrollo de estudios de mercado sobre el comportamiento, necesidades, gustos e intereses de los Usuarios sobre la Plataforma;</It>
      ...
      <It m="(k)">Mejorar de las iniciativas comerciales y promocionales de Alkyo;</It>
      <It m="(l)">Realizar gestión de estadísticas internas, con el objetivo de hacer seguimiento a los servicios ofrecidos;</It>
      <It m="(m)">Enviar información y/o comunicaciones por cualquier medio que hubiese sido brindado por el Titular a Alkyo (mensajes de texto al teléfono celular, redes sociales, correo electrónico entre otros) sobre nuevos servicios, cambio en el servicio y tarifas, recordatorios de pago, promociones, eventos e información de interés para los Usuarios;</It>
      <It m="(n)">Compartir los Datos Personales con los proveedores de servicios y en general terceros para el cumplimiento de las obligaciones de Alkyo. Alkyo no se hace responsable por el uso indebido que estas personas o entidades puedan darle a la información;</It>
      ...
      <It m="(q)">Darle Tratamiento a la información en medios físicos y digitales, asegurando que estén correctamente utilizados por parte de Alkyo;</It>
      <It m="(r)">Contactar y/o enviar información, por cualquier medio, sobre servicios que Alkyo considere pueden ser de interés por parte del Titular. Así como envío de cualquier otro tipo de comunicaciones  y  actividades  relacionadas  con  el  objeto  social  de Alkyo;</It>
      <It m="(s)">La información suministrada por el Usuario, será utilizada por Alkyo para efectos de facturación (en caso de aplicar) y demás efectos tributarios, en este caso será compartida con las entidades del Estado encargadas de desarrollar, supervisar o gestionar dicha labor;</It>
      ...
      <It m="(x)">Reportar a las centrales de información, sobre el cumplimiento o incumplimiento de las obligaciones por concepto de la prestación del servicio o por cualquier otra obligación que haya adquirido con Alkyo, o quien éste designe.</It>
      ...
      <It m="(b)">Derecho de actualización. Conocer, actualizar y rectificar sus Datos Personales frente a Alkyo o a los Encargados del Tratamiento de los mismos. Este derecho se podrá ejercer frente a Datos Personales parciales, inexactos, incompletos, fraccionados, que induzcan a error, o aquellos cuyo Tratamiento esté expresamente prohibido o no haya sido autorizado.</It>
      <It m="(c)">Derecho de prueba.  Solicitar prueba de la existencia de la autorización otorgada a Alkyo, salvo cuando expresamente se exceptúe como requisito para el Tratamiento de acuerdo con la ley aplicable.</It>
      <It m="(d)">Derecho de información. Presentar solicitud correspondiente a Alkyo o al Encargado del Tratamiento sobre la información respecto al uso que se le ha dado a su Datos Personales.</It>
      ...
      <It m="7.1.">Alkyo recolecta los Datos Personales de sus Usuarios a través de la Plataforma y del uso de la misma.</It>
      <Gap />
      <It m="7.2.">Los Usuarios que realicen el proceso de creación de una cuenta en Alkyo deberán diligenciar el formulario correspondiente a sus Datos Personales y los datos de la Pyme a la que representan para poder acceder a su cuenta.</It>
      <Gap />
      <It m="7.3.">Alkyo también podrá recolectar Datos Personales de los Usuarios por el acceso a productos que se integran en aplicaciones y sitios web de terceros. Si el Usuario decide registrarse para obtener una cuenta utilizando sus credenciales de un servicio de terceros su nombre y dirección de correo electrónico nos serán facilitados según lo permita la configuración de su perfil en dicho servicio de tercero.</It>
      <Gap />
      <It m="7.4.">Cuando el Usuario interactúa con Alkyo a través de los Servicios, automáticamente recopilamos información sobre usted a través de cookies (pequeños archivos de texto colocados en su dispositivo), identificador de dispositivo móvil y otras tecnologías. Por favor, lea la sección quince (15) &quot;Cookies y Otras Herramientas Tecnológicas&quot; a continuación para obtener más información sobre cómo utilizamos las cookies y otras tecnologías. Cuando visita nuestros sitios web, nuestros servidores registran información (&quot;datos de registro&quot;), incluida la información que su navegador envía automáticamente cada vez que visita el sitio web. Estos datos de registro incluyen su dirección de Protocolo de Internet (&quot;IP&quot;) (desde la que entendemos el país desde el que se está conectando en el momento en que visita el Sitio), el tipo de navegador y su configuración, y la fecha y hora de su solicitud</It>
      <Gap />
      <It m="7.5.">En los casos en los que se trate de diligenciamiento de formularios, los Datos Personales que Alkyo podrá solicitar del Titular los siguientes datos, así como cualquier otro que estime pertinente:</It>
      ...
      <It m="8.1.">Alkyo sólo debe solicitar autorización de acuerdo con los requisitos de la ley aplicable. La autorización del Titular de la información no será necesaria cuando lo determine la ley aplicable.</It>
      <It m="8.2.">En el evento de una venta, fusión, consolidación, cambio en el control societario, transferencia de activos, reorganización o liquidación de Alkyo y/o sus entidades Vinculadas y/o Relacionadas, Alkyo podrá transferir los Datos Personales de los Titulares a las partes involucradas, para lo cual por medio de la aceptación del presente documento Alkyo se entiende queda facultada para realizarlo.</It>
      ...
      <Gap />
      <It m="9.2.">Rectificaciones y Reclamos. Cuando el Titular de la Información advierta un presunto incumplimiento por parte de Alkyo de sus deberes en materia de Protección de Datos Personales y deseen ejercer sus derechos contenidos en la legislación aplicable y en la presente Política, podrán presentar un reclamo ateniéndose a los siguientes requisitos y procedimiento:</It>
      ...
      <p>La radicación de solicitud se formulará mediante comunicación dirigida al área encargada de Alkyo según se indica más adelante, con la identificación del Titular, la descripción de los hechos que dan lugar a la solicitud, la dirección y acompañado de los documentos que soporten la solicitud de ser aplicable.</p>
      <It m="(b)">Si la solicitud resulta incompleta, Alkyo requerirá al interesado dentro del término determinado por la ley aplicable para que complete y subsanase su petición. Transcurridos el término determinado por la ley aplicable desde la fecha del requerimiento, sin que el solicitante presente la información requerida, se entenderá que ha desistido de la Rectificación y/o Reclamo.</It>
