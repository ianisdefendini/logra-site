  ...
  return (
    <footer style={{ background: "#111111", padding: "40px 20px 60px" }}>
      <style>{`
        ...
        .bancos-footer-bottom {
          display: flex;
          justify-content: space-between;
          align-items: center;
        }
        .bancos-footer-bottom-right { display: flex; gap: 40px; }
        .bancos-footer-link { transition: opacity 0.2s ease; }
        .bancos-footer-link:hover { opacity: 0.7; }
        @media (max-width: 809px) {
          .bancos-footer-top { flex-direction: column; gap: 24px; }
          .bancos-footer-links { align-items: flex-start; gap: 12px; }
          .bancos-footer-bottom {
            flex-direction: column;
            align-items: flex-start;
            gap: 24px;
          }
          .bancos-footer-bottom-right { flex-direction: column; gap: 12px; }
        }
      `}</style>
      <div style={{ maxWidth: 1400, margin: "0 auto" }}>
        <div className="bancos-footer-top">
          <div>
            <span
              style={{
          ...
          <div className="bancos-footer-links">
            {navLinks.map((link) => (
              <a
                key={link.label}
                href={link.href}
        ...
        <div
          className="bancos-footer-bottom"
          style={{
            fontFamily: "var(--font-logra-body), Inter, sans-serif",
            fontSize: 15,
            fontWeight: 400,
        ...
        >
          ...
          <div className="bancos-footer-bottom-right">
            <a
