    ...
    <section style={{ background: "#faf9f7", padding: "42px 20px 60px" }}>
      <style>{`
        ...
        @media (max-width: 899px) {
          .bancos-inst-logos { gap: 48px; margin-top: 40px; }
        }
      `}</style>
      <div style={{ maxWidth: 1240, margin: "0 auto", textAlign: "center" }}>
        ...
        <LograAppear delay={0.15}>
          <div className="bancos-inst-logos">
            <img
              src={`${CAM_IMG_BASE}/logo-strip-0-160x32.svg`}
              alt="Colsubsidio"
            ...
            />
            <img
              src={`${CAM_IMG_BASE}/logo-strip-1-113x40.svg`}
              alt="Davivienda"
