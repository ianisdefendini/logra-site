...
// Colsubsidio / Davivienda wordmark SVGs are shared static assets extracted
// with the camaras page (same logo strip on the original site).
const CAM_IMG =
    ...
    <section style={{ background: "#faf9f7", padding: "42px 20px 60px" }}>
      <style>{`
        ...
        @media (max-width: 899px) {
          .inst-logos-row { gap: 48px; margin-top: 40px; }
        }
      `}</style>
      <div style={{ maxWidth: 1240, margin: "0 auto", textAlign: "center" }}>
        ...
        <LograAppear delay={0.15}>
          <div className="inst-logos-row">
            <img
              src={`${CAM_IMG}/logo-strip-0-160x32.svg`}
              alt="Colsubsidio"
            ...
            />
            <img
              src={`${CAM_IMG}/logo-strip-1-113x40.svg`}
              alt="Davivienda"
